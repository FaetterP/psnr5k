...
namespace Assets.Scripts.Tutorial
{
    class TurnOff : TutorialBase<TurnOff>
    {
        ...
        private Step<TurnOff>[] _steps = new Step<TurnOff>[] {
            ...
            new Step<TurnOff>("установить переключателем +-ε угол места 0 по шкале прибора КОНТРОЛЬ", (t) => { return t._control.Value == 1; }),
            new Step<TurnOff>("установить переключатель КОНТРОЛЬ в положение 24", (t) => { return t._control.Value == 3; }),
