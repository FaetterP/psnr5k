...
namespace Assets.Scripts.Screens.MainScreen.Bulges
{
    ...
    {
        public BulgeTriangle(float size, float maxAmplitude, float range, float azimuth, Transform leftLine, string sound, AudioSource audioSource) : base(size, maxAmplitude, range, azimuth, leftLine, sound, audioSource) { }
